function buttonClicked(value) {
    ...
    document.location.href = updateURLparameters("clientProfile", "edit", true);
}
...
function toggleDisplayTrainingSettings(value) {
     document.location.href = updateURLparameters("clientProfile/training", "id", value);
}